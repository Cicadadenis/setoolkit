...
def show_banner(define_version, graphic):
    ...
    print(bcolors.BLUE + """
[---]        Социально-инженерный инструментарий (""" + bcolors.YELLOW + """SET""" + bcolors.BLUE + """)         [---]
[---]        Создатель:""" + bcolors.RED + """ Bednakov-Xack-Live """ + bcolors.BLUE + """(""" + bcolors.YELLOW + """DENIS""" + bcolors.BLUE + """)             [---]
                      Версия: """ + bcolors.RED + """%s""" % (define_version) + bcolors.BLUE + """
                    Codename: '""" + bcolors.YELLOW + """Bednakov D L""" + bcolors.ENDC + bcolors.BLUE + """'
[---]        Follow us on Twitter: """ + bcolors.PURPLE + """@Bednakov""" + bcolors.BLUE + """                   [---]
[---]        Follow me on Twitter: """ + bcolors.PURPLE + """@Bednakov-Xack-Live""" + bcolors.BLUE + """         [---]
[---]       Homepage: """ + bcolors.YELLOW + """https://www.github.com/bednakovdenis""" + bcolors.BLUE + """     [---]
""" + bcolors.GREEN + """             Добро пожаловать в Социально-инженерный инструментарий .
           Универсальный магазин для всех ваших потребностей SE.
""")
    print(bcolors.BOLD + """   Социально-инженерный инструментарий  является продуктом Bednakov-Xack-Live.\n\n           Разработчик: """ +
          bcolors.GREEN + """https://www.github.com/bednakovdenis\n""" + bcolors.ENDC)
    print(bcolors.BLUE + """   Это легко обновить с помощью PenTesters Framework! (PTF)\nVisit """ + bcolors.YELLOW +
          """https://github.com/bednakovdenis/setoolkit""" + bcolors.BLUE + """ обновить все ваши инструменты!\n\n""" + bcolors.ENDC)
